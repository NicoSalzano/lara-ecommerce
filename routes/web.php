...
Route::middleware('auth')->group(function () {
    ...
    Route::put('/profile',[UserProfileController::class, 'updateProfile'])->name('updateProfile');
    Route::post('/profile',[UserProfileController::class,'updatePassword'])->name('updatePassword');
});